...
class ParameterController
{
    ...
    {
        if (!in_array($aArgs['id'], ['minimumVisaRole', 'maximumSignRole', 'suggest_links_n_days_ago', 'workflowSignatoryRole']) && !PrivilegeController::hasPrivilege(['privilegeId' => 'admin_parameters', 'userId' => $GLOBALS['id']])) {
