    ...
    public function checkSendToRecordManagement(Request $request, Response $response, array $aArgs)
    {
        ...
        foreach ($body['resources'] as $resId) {
            ...
            if (empty($doctypesData[$typeId]['retention_rule']) || empty($doctypesData[$typeId]['retention_final_disposition']) || empty($doctypesData[$typeId]['duration_current_use'])) {
                ...
                if ($resources[$resId]['binding'] === null && !in_array($doctypesData[$typeId]['action_current_use'], ['transfer', 'sae_copy'])) {
                    ...
                    continue;
                } elseif ($resources[$resId]['binding'] === true && !in_array($bindingDocument['param_value_string'], ['transfer', 'sae_copy'])) {
                    ...
                    continue;
                } elseif ($resources[$resId]['binding'] === false && !in_array($nonBindingDocument['param_value_string'], ['transfer', 'sae_copy'])) {
